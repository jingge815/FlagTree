<<<<<<< flagtree/third_party/ascend/unittest/pytest_ut/test_asm.py
import triton
...
def test_case_2d(param_list):
    ...
    test_common.validate_cmp(dtype, res_cal, res_ref)
>>>>>>> triton-ascend@HEAD/third_party/ascend/unittest/pytest_ut/test_asm.py
