<<<<<<< flagtree/third_party/ascend/language/cann/extension/mem_ops.py
import numbers
...
def index_select(src: tensor, idx: tensor, bound, lstdim_blksiz, offsets, numels, _builder=None):
    ...
    def embedding_gather_impl(src: tl.tensor, idx: tl.tensor, bound: int, blksiz: int, offsets: Tuple, numels: Tuple,
...
def index_put(ptr: tensor, index: tensor, value: tensor, dim: int, index_boundary: int, end_offset: tuple,
    ...
    *******
    ...
    def index_put_impl(ptr: tl.tensor, index: tl.tensor, value: tl.tensor, dim: int, index_boundary: int,
        ...
        return tl.tensor(
            builder.create_index_put(ptr.handle, index.handle, value.handle, dim, index_boundary, end_offset,
...
>>>>>>> triton-ascend@HEAD/third_party/ascend/language/cann/extension/mem_ops.py
